      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <div key={index} className="bg-gray-900 border border-gray-700 rounded-xl shadow-lg p-8 hover:shadow-xl hover:border-gray-600 transition-all">
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {exp.projects.map((project, projectIndex) => (
                    <div key={projectIndex} className="border border-gray-600 rounded-lg p-6 hover:border-red-500/50 transition-colors bg-gray-800/50">
