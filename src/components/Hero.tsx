    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
        ...
        <div className="space-y-8 animate-fade-in">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tight">
                ...
                <span className="block text-4xl lg:text-5xl text-gray-300 font-medium mt-3">
                  Business Analytics & AI
                </span>
                <span className="block text-4xl lg:text-5xl text-gray-300 font-medium">
                  Professional Based In Houston
                </span>
              </h1>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              ...
              className="group relative bg-red-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-red-700 transition-all duration-300 hover:scale-105 shadow-lg"
            >
              <span className="relative z-10">Hire Me</span>
            </button>
            <button
              onClick={() => scrollToSection("contact")}
              className="group flex items-center gap-2 border border-gray-600 text-gray-300 px-8 py-4 rounded-lg font-semibold hover:border-gray-500 hover:text-white hover:bg-gray-800/50 transition-all duration-300 hover:scale-105 backdrop-blur-sm"
            >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <button
          ...
          className="group flex flex-col items-center text-gray-400 hover:text-gray-300 transition-all duration-300 p-4 rounded-2xl hover:bg-gray-800/60 backdrop-blur-sm"
        >
